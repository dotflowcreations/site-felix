 ...
 * Strictly non-clinical analytical reference standards only.
 */
...
// Research Materials Catalog (Inventory removed)
const products = [];
...
const COAS_DATABASE = [
  {
    ...
    "variant": "Semaglutide 15mg Lyophilized Standard",
    "batch": "040825-S15-W",
  ...
  },
  {
    ...
    "variant": "Semaglutide 10mg Lyophilized Standard",
    "batch": "022825-S10",
  ...
  },
  {
    ...
    "variant": "Semaglutide 5mg Lyophilized Standard",
    "batch": "040825-S05-W",
  ...
  bodyEl.innerHTML = `
    <div class="lightbox-cert-card">
      ...
      <div class="lightbox-specs-grid">
        ...
        ${coa.quantity ? `
        <div>
          <div style="font-size:11px; text-transform:uppercase; color:#64748b; font-weight:600;">Analyte Content</div>
    ...
    <div class="modal-body">
      ...
      <div class="modal-specs-table">
        ...
        <div class="modal-spec-row">
          ...
          <span class="spec-value">${p.reconstitution || 'Soluble in laboratory buffer / HPLC mobile phase for analytical assay.'}</span>
        </div>
        <div class="modal-spec-row">
          <span class="spec-label">Storage Conditions:</span>
          <span class="spec-value">${p.storage || 'Store desiccated at -20°C in sealed container for analytical stability'}</span>
        </div>
        <div class="modal-spec-row">
          <span class="spec-label">Regulatory Status:</span>
          <span class="spec-value" style="color:var(--fx-primary);font-weight:600;">Non-clinical analytical reference material</span>
        </div>
      </div>
      ...
      <div class="modal-compliance-box">
        <strong>Analytical Reference Material:</strong> Provided exclusively for in-vitro laboratory assay, instrumental calibration, and non-clinical scientific evaluation.
      </div>
...
function renderPaymentDetails() {
  ...
  panel.innerHTML = `
    <div class="payment-details-grid">
      ...
      <div class="payment-spec-box">
        <div class="payment-spec-label">Transfer Verification</div>
